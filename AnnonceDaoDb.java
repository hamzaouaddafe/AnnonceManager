...
public class AnnonceDaoDb implements AnnonceDao{
	...
	public AnnonceDaoDb(UserDao userDao) {
		...
		annonces.add(new Annonce(1, new Domain(1, "Telephone"), userDao.select(1), 1000, "Iphone X"));
		annonces.add(new Annonce(2, new Domain(2, "Voiture"), userDao.select(2), 4500, "BMW"));
		annonces.add(new Annonce(3, new Domain(3, "Telephone"), userDao.select(3), 700, "Iphone 8"));
		annonces.add(new Annonce(4, new Domain(4, "Telephone"), userDao.select(2), 150, "Samsung s6"));
		annonces.add(new Annonce(5, new Domain(5, "Telephone"), userDao.select(4), 900, "Iphone X"));
	}
