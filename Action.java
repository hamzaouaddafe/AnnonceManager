...
public class Action {
        ...
        if (!isBadRequest(request)) {
            ...
            if ("connected".equals(request)) {
                ...
                if (request.equals("annonce")) {
                    ...
                    return consolePrinter.annonces(
                            services.selectAnnoncesByUsername(username),
                            "ID",
                            "Déscription",
                            "Prix",
                            "Type",
                ...
                return consolePrinter.annonces(
                        services.selectAnnoncesByUser(this.connectedUser),
                        "ID",
                        "Déscription",
                        "Prix",
                        "Type",
    ...
    private String addAnnonce(String request) {
        ...
        Annonce annonce =
                new Annonce(new Domain(type), connectedUser, Integer.parseInt(price), description);
        services.insertAnnonce(annonce);

        return consolePrinter.annonces(
                services.selectAnnonces(),
                "Déscription",
                "Prix",
                "Type",
                "E-mail auteur de l'annonce");
